                                ...
                                <div className="col-xl-7 col-lg-8 order-first-md">
                                    <div className="footer__top-left">
                                        <div className="row">
                                            ...
                                            </div><div className="col-xl-5 col-lg-6 col-md-6 col-sm-6">
                                                <div className="footer__widget">
                                                    <div className="footer__widget-title mb-20">
                                                        <h4>About The Store</h4>
                                                    </div>
                                                    <div className="footer__widget-content">
                                                        <p className="footer-text mb-35">Our mission statement is to provide the absolute best customer experience available in the Electronic industry without exception.</p>
                                ...
                                <div className="row">
                                    <div className="col-xl-12">
                                        ...
                                        <div className="copy-right-area text-center">
                                            <p>Copyright © <span>DukaMarket.</span> All Rights Reserved. Powered by <a href="#"><span className="main-color">Theme_Pure.</span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
